...
func TestEndpointService_IntrusionPreventionExclusionDelete(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, res, err := client.Endpoints.IntrusionPreventionExclusionDelete(tt.ctx, "tenantid-guid", "", "id")
